...
public class MyAdapter extends BaseAdapter{
    ...
    @Override
    public int getCount() { //นับจำนวนข้อมูลใน Array (getCount) แล้วส่งข้อมูลไปยัง Method getView()
        return ints.length;
    }
    ...
    @Override
    public View getView(int i, View view, ViewGroup viewGroup) {//รับข้อมูลจาก Method getCount() มาแสดงบน App
        ...
        //ผูกตัวแปลบย Java กับอิลิเมนต์บน XML ที่หน้า my_listview
